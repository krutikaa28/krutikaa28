...
**Description:**  
A frontend web application built using **React.js**, focusing on clean UI, component-based architecture, and responsive design.
...
<!--### 🔹 MERN Stack Project  
**Project Name:** *Thooli Web*  

**Description:**  
A **full-stack MERN application** that integrates a React frontend with a Node.js + Express backend and MongoDB database.
...
**Description:**  
A full-stack To-Do application that allows users to manage tasks with persistent data storage.
...
<!--🔗 **Live Demo:** *[]*  -->
📁 **Repository:** *[https://github.com/krutikaa28/node-batch-2.git]*  
...
- Writing cleaner and more maintainable full-stack code  
